...
/**
 * Central repository for lint rule patterns evaluated by {@link
 * com.codename1.server.mcp.service.LintService}.
 */
public final class RulePack {
  ...
  public static final List<Pattern> FORBIDDEN =
      List.of(
  ...
  public static final List<Pattern> FORBIDDEN_FQNS =
      List.of(
  ...
  public static final Pattern CALLS_SERIAL =
      Pattern.compile("Display\\.getInstance\\(\\)\\.(callSerially|callSeriallyAndWait)\\s*\\(");
