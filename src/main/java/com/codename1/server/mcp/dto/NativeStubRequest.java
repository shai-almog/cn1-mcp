...
/**
 * Request payload for the native stub generation tool. The caller supplies the Java source files
 * that make up the compilation unit (at minimum the native interface itself) along with the
 * fully-qualified interface name that should be processed.
 */
